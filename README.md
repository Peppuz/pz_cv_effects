...
The list have to provide some short description after that the code got tested.

---------

## Retro Filters
* _Repository:_ [retroimagify](https://github.com/t33bu/retroimagify)
  
  _License:_ CC BY-NC-SA 4.0


## 3D Ken Burns 
* _Paper:_ [3D Ken Burns Effect from a Single Image.](https://github.com/sniklaus/3d-ken-burns/)
...
## Super Resolution
* _Paper:_ [Enhanced Deep Residual Networks for Single Image Super-Resolution.](https://github.com/thstkdgus35/EDSR-PyTorch)
  
  _Lincense:_ MIT
  
* _Paper:_ [Superresolution using an efficient sub-pixel convolutional neural network.](https://github.com/pytorch/examples/tree/master/super_resolution)
